...
class ResponseCache:
    ...
    In-memory semantic cache with false-hit guardrails.
...
class SharedRedisCache:
    ...
    Redis implementation of the shared cache contract
    ...
    def get(self, query: str) -> tuple[str | None, float]:
        ...
        if best_key is not None and best_response is not None and best_score >= self.similarity_threshold:
